...
public class PadlNode extends InlineFun {
	/*
	 * Constructor.
	 */
	public PadlNode(Parser parser) {
		super(parser);
	}
	public Object eval() {
		Object parameter = getVariable("padlNodeParameter");
		Object parameter2 = getVariable("padlNodeParameter2");
		Object parameter3 = getVariable("padlNodeParameter3");
